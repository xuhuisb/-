...
namespace ePS_Robot.公共函数
{
    class SpeechModel
    {
        ...
        public SpeechModel()
        {
            APIID = "15583917"; // can be anything here, just be unique anyway
            APIKey = "2a782Tk1vs7oMetxWqsnPkw7"; // Your key
            APISecretKey = "Gq3bfMf9gkL4B72CXI4QwsXD0xyQ4xS0"; // Your secret key
